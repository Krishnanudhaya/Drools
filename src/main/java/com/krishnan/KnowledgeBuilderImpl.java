...
public class KnowledgeBuilderImpl implements KnowledgeBuilder,
     ...
     */
    public org.drools.compiler.builder.impl.KnowledgeBuilderConfigurationImpl getBuilderConfiguration() {
        return this.configuration;
    }

    public org.drools.compiler.compiler.PackageRegistry getPackageRegistry(String name) {
