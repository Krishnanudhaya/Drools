...
public class PackageRegistry {
    ...
    public PackageRegistry(ClassLoader rootClassLoader, com.krishnan.KnowledgeBuilderConfigurationImpl configuration, InternalKnowledgePackage pkg) {
        this.pkg = pkg;
        this.dialectCompiletimeRegistry = configuration.buildDialectRegistry(rootClassLoader, configuration, this, pkg);
